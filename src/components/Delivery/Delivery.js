import { faClock, faGlobeAmericas, faParachuteBox } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className={styles.deliveryWrapper}>
            ...
            <div className={styles.deliveryMap}>
                <div className={styles.deliveryMapWrapper}>
                    <iframe title ='MapGide' src="https://yandex.ru/map-widget/v1/?um=constructor%3A2a266067a0b9ad1b5eb2ef474d6ce22a6bb4cc6f1dacac5ef50b7c697384b0e6&amp;source=constructor" width="600" height="366" frameBorder="0"></iframe>
                </div>
            </div>
            <div className={styles.deliveryTerm}>
                ...
                <div>
                     <FontAwesomeIcon icon={faParachuteBox} className={styles.icon}  size="3x" />
                     <p>Бесплатная доставка</p>
                </div>
                <div>
                     <FontAwesomeIcon icon={faGlobeAmericas} className={styles.icon} size="3x" />
